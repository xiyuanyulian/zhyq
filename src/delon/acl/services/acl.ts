...
export class ACL {
    ...
    public constructor(val: string | string[] | ACLType = [], full: boolean = false) {
        this.full = full;
        const a = this.parseACLType(val);
        this.roles = a.role;
    }

    public parseACLType(val: string | string[] | ACLType): ACLType {
