...
export class PageHeaderComponent implements OnInit, OnChanges, AfterViewInit, OnDestroy {
  ...
  @ContentChild('breadcrumb', {static: false}) breadcrumb: TemplateRef<any>;

  @ContentChild('logo', {static: false}) logo: TemplateRef<any>;

  @ContentChild('action', {static: false}) action: TemplateRef<any>;

  @ContentChild('content', {static: false}) content: TemplateRef<any>;

  @ContentChild('extra', {static: false}) extra: TemplateRef<any>;

  @ContentChild('tab', {static: false}) tab: TemplateRef<any>;
