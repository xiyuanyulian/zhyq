...
class TestComponent {
    type = 'custom';
    @ViewChild('comp', {static: false}) comp: ResultComponent;
    @ViewChild('titleTpl', {static: false}) titleTpl: TemplateRef<void>;
    @ViewChild('descriptionTpl', {static: false}) descriptionTpl: TemplateRef<void>;
    @ViewChild('extraTpl', {static: false}) extraTpl: TemplateRef<void>;
